...
// Addresses
#define UNIT_MAC 0x00 // The address of this gateway (0x00 for MQTT gateway)
...
// Interfaces
#define USE_WIFI // Enable WiFi and MQTT
// #define USE_ESPNOW  // Uncomment if you also want ESP-NOW
// #define USE_LORA    // Uncomment if you also want LoRa
// #define USE_ETHERNET
...
#define SERIAL_ACT sendMQTT(); // This handles data coming from Serial2 (PortC)
#define MQTT_ACT sendSerial();
#define INTERNAL_ACT sendMQTT();
#define ESPNOW1_ACT sendMQTT();
#define ESPNOW2_ACT sendMQTT();
#define LORA1_ACT sendMQTT();
#define LORA2_ACT sendMQTT();
...
#define RXD2 13 // PortC RX pin
#define TXD2 14 // PortC TX pin

// #define USE_LR  // Use ESP-NOW LR mode (ESP32 only)

// WiFi and MQTT Credentials  -- These will override the global settings
#define WIFI_SSID "DLGG_HOME"
#define WIFI_PASS "li89400838"
...
// MQTT Settings
#define MQTT_ADDR "192.168.68.108"
#define MQTT_PORT 1883 // Default MQTT port is 1883
#define MQTT_AUTH      // Enable MQTT authentication
#define MQTT_USER "core2"
...
#define TIME_SERVER "0.us.pool.ntp.org" // NTP time server to use. If FQDD at least one DNS server is required to resolve name
