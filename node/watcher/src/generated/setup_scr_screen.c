...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_img_1, 66, 77);
    lv_obj_set_size(ui->screen_img_1, 128, 128);
    lv_obj_add_flag(ui->screen_img_1, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_1, &_heartrate_RGB565A8_128x128);
    ...
    lv_obj_set_pos(ui->screen_img_2, 66, 210);
    lv_obj_set_size(ui->screen_img_2, 128, 128);
    lv_obj_add_flag(ui->screen_img_2, LV_OBJ_FLAG_CLICKABLE);
    lv_image_set_src(ui->screen_img_2, &_oxygen_RGB565A8_128x128);
    ...
    lv_obj_set_pos(ui->screen_label_1, 220, 120);
    lv_obj_set_size(ui->screen_label_1, 82, 48);
    lv_label_set_text(ui->screen_label_1, "78");
    ...
    lv_obj_set_pos(ui->screen_label_2, 220, 240);
    lv_obj_set_size(ui->screen_label_2, 100, 32);
    lv_label_set_text(ui->screen_label_2, "100");
    ...
    lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_montserratMedium_36, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_3, 135, 345);
    lv_obj_set_size(ui->screen_label_3, 145, 18);
    lv_label_set_text(ui->screen_label_3, "No Finger!");
    lv_label_set_long_mode(ui->screen_label_3, LV_LABEL_LONG_WRAP);

    //Write style for screen_label_3, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_radius(ui->screen_label_3, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_3, lv_color_hex(0xec0000), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_4, 126, 41);
    lv_obj_set_size(ui->screen_label_4, 155, 21);
    lv_label_set_text(ui->screen_label_4, "oximeter_node2");
